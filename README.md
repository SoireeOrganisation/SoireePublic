...
## Содержание
  ...
  * [Реализация в облаке Microsoft Azure](https://github.com/Bopobywek/Soiree/blob/main/README.md#%D1%80%D0%B5%D0%B0%D0%BB%D0%B8%D0%B7%D0%B0%D1%86%D0%B8%D1%8F-%D0%B2-%D0%BE%D0%B1%D0%BB%D0%B0%D0%BA%D0%B5-microsoft-azure)
...
> Рейтинг — суммарная оценка сотрудника за рабочий день <br/><br/>

### О проекте
Платформа направлена на повышение работоспособности коллектива за счёт улучшения взаимоотношений между сотрудниками компании. <br/>

Сотрудникам предлагается каждый рабочий день анонимно оценивать своих коллег по совокупности параметров. Система в это время будет следить за рейтингом сотрудника и при необходимости напомнит человеку о важности доброжелательного отношения к своим коллегам. <br/>

Руководству предоставляется возможность анализировать уровень напряженности в коллективе. Для этого система может предоставлять отчёт. Также (по желанию руковдителя) некоторые сотрудники могут быть вознаграждены.

### Роли
1. Системный администратор
2. Менеджер по продажам
3. Руководитель компании (заказчик)
4. Сотрудник компании

**Системный администратор**
-----
Поддерживает работоспособность платформы, а также регистрирует в системе компании, которые подключились к платформе.

**Менеджер по продажам**
-----
Коммуницирует с компанией-заказчиком во время процесса подключения компании к плафторме.

**Руководитель компании (заказчик)**
-----
Аффилированное лицо компании-заказчика. Имеет доступ к статистике сотрудников, может назначать сотрудникам вознаграждения.

**Cотрудник компании**
-----
Каждый рабочий день оценивает своих коллег. Имеет доступ к личной статистике, которая включает в себя анонимизированные оценки, а также назначенные вознаграждения.
